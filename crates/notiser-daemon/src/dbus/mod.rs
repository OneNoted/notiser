...
use self::notiser::NotiserService;
    ...
    let handle = std::thread::Builder::new()
        ...
        .spawn(move || {
            ...
            rt.block_on(async move {
                let service = NotificationService::new(command_tx.clone());
                let notiser_service = NotiserService::new(command_tx);
                ...
                let conn = zbus::connection::Builder::session()
                    ...
                    .name("org.notiser.Daemon")
                    .expect("failed to request notiser bus name")
                    .serve_at("/org/notiser/Daemon", notiser_service)
                    .expect("failed to serve notiser interface")
                    .build()
                    .await
